...
8.  If your changes are ready for prime time, enter `quarto publish` into the Terminal. It will ask you to confirm if you want to update the website version of the Guide by typing "Yes"/"y"/"Y".![](images/quarto_publish.png)
